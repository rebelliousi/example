...
// src/hooks/ApplicationList/useApplicationListById.ts
...
// OlympicFile interface'ini ekliyoruz
...
export interface Olympic {
  ...
  description: string;
  files: OlympicFile[]; // OlympicFile tipini kullanıyoruz
}
...
const getApplicationById = async (id: string): Promise<IApplicationData> => {
