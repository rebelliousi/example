...
const ApplicationForm: React.FC = () => {
    ...
    const handleInstitutionChange = (index: number, e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        const { name, value } = e.target;
        setApplication(prev => {
            const newInstitutions = [...prev.institutions];
            newInstitutions[index] = {
                ...newInstitutions[index],
                [name]: name === 'school_gpa' || name === 'graduated_year' ? Number(value) : value
            };
            return {
                ...prev,
    ...
    const handleInstitutionFileUpload = (index: number, e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleOlympicChange = (index: number, e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
        const { name, value } = e.target;
        setApplication(prev => {
    ...
    const handleOlympicFileUpload = (index: number, e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            const file = e.target.files[0];
            setApplication(prev => {
                const newOlympics = [...prev.olympics];
    ...
    const removeItem = (type: 'guardians' | 'institutions' | 'olympics' | 'documents', index: number) => {
        setApplication(prev => ({
            ...prev,
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        const newMajors = e.target.checked
                                                            ...
                                                            : application.admission_major.filter(id => id !== major.id);
                                                        setApplication(prev => ({
                                                            ...prev,
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-3">
                                            ...
                                            {institution.certificate && (
                                                <span className="text-sm text-gray-600">Selected: {(institution.certificate as File).name}</span>
                                            )}
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-3">
                                            ...
                                            />
                                            {olympic.file && (
                                                <span className="text-sm text-gray-600">Selected: {(olympic.file as File).name}</span>
                                            )}
                                        </td>
                                    </tr>
                                </tbody>
                                ...
                                <tbody>
                                    <tr className="border-b">
                                        ...
                                        <td className="p-3">
                                            ...
                                            >
                                                ...
                                                <option value="military_document">Military Document</option>
                                                <option value="information">Information</option>
                                                <option value="relationship_tree">Relationship Tree</option>
                                    ...
                                    <tr>
                                        ...
                                        <td className="p-3">
                                            ...
                                            />
                                            {document.file && (
                                                <span className="text-sm text-gray-600">Selected: {(document.file as File).name}</span>
                                            )}
                                        </td>
                                    </tr>
                                </tbody>
