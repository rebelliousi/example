...
const Dashboard = () => {
  ...
  const maleCount =
    statistics.gender_stats.find((stat) => stat.user__gender === 'male')
      ?.count || 0;
  const femaleCount =
    statistics.gender_stats.find((stat) => stat.user__gender === 'female')
      ?.count || 0;
    ...
    <div className="p-6 bg-gray-50 max-2xl:px-5 ">
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="col-span-3  mt-[-110px]">
          <SpecialGroups
            vipCount={statistics.special_cases?.vip_count || 0}
            orphanCount={statistics.special_cases?.orphan_count || 0}
          />
        </div>
