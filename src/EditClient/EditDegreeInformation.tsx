...
const EditDegreeInformationForm = () => {
    const degreeOptions = [
    ...
    const { degree, primaryMajor, additionalMajors, setDegree, setPrimaryMajor, setAdditionalMajors } = useApplicationStore();
        ...
        <div className="pt-10 px-4">
            ...
            <Space direction="vertical" size="middle" className="w-full">
                ...
                <div className="flex justify-end mt-10 space-x-5">
                    <LinkButton to="/application_list"
