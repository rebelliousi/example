  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 w-full h-56">
      ...
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-semibold">Online applications</h3>
      ...
      <div className="flex items-center justify-center space-x-2">
        <div className="flex items-center justify-start mt-6 bg-blue-50 py-2 px-2">
        ...
        {/* Verified & Waiting */}
        <div className="pl-4 flex justify-start mt-6 gap-6 text-sm">
          <div className="border-r pr-4">Verified: <strong>123</strong> (15%)</div>
          <div>Waiting: <strong>123</strong> (15%)</div>
        </div>
      </div>
    </div>
  );
